...
- Write a short 3-10-word description of what each file does.
  - cpu.py - is the structure of the program, this holds the initialization aspect of the program
  - ls8.py - this is where we will execute the program
  - prints8.ls8 - is where the raw data is to be executed
